...
class OnGoingResearchModel(db.Model):
    ...
    def json(self):
        return {'id': self.id, 'research_field': self.research_field, 'research_topic': self.research_topic, 'description': self.description, 'num_of_students': self.num_of_students, 'research_desc_link': self.research_desc_link}