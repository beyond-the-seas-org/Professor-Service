...
from professors.apis.Get_Locationbased_Professors import Get_locationbased_professors
...
Professors.add_resource(Get_locationbased_professors,'/<int:location_id>/get_locationbased_professors')
